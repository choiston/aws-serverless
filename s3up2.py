...
예시:
    python3 s3up2.py --bucket my-bucket upload ./photo.jpg images/photo.jpg
    python3 s3up2.py --bucket my-bucket list --prefix images/
    python3 s3up2.py --bucket my-bucket download images/photo.jpg ./photo.jpg
    python3 s3up2.py --bucket my-bucket delete images/photo.jpg
    python3 s3up2.py --anonymous --bucket my-bucket upload ./photo.jpg images/photo.jpg
...
def parse_args():
    ...
    parser.add_argument("--anonymous", action="store_true", help="AWS 자격 증명 없이 요청")
...
def main():
    ...
    try:
        session = boto3.Session(
            profile_name=None if args.anonymous else args.profile, region_name=args.region
        )
        if args.anonymous:
